...
<head>
	...
	$(function(){
        ...
        $("#editPwdBtn").click(function () {
            ...
            // 1.根据 id 查询当前用户的信息
            $.ajax({
                url:'settings/qx/user/queryUserById.do',
                data:{
                ...
                success:function (data) {
                    /*
                        data = user{id, loginAct, name, loginPwd, ...}
                     */
                    // alert(data.loginPwd);
                    $("#oldPwd").val(data.loginPwd);
                }
            });
        });
		...
		<div style="position: absolute; top: 15px; right: 15px;">
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu" style="position: absolute; left: -40px;">
						<li><a href="settings/index.do"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
						<li><a href="javascript:void(0)" data-toggle="modal" data-target="#myInformation"><span class="glyphicon glyphicon-file"></span> 我的资料</a></li>
						<li><a href="javascript:void(0)" id="editPwdBtn" data-toggle="modal" data-target="#editPwdModal"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
