...
<head>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="edit-transactionOwner">
					<option selected>${tran.owner}</option>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="edit-activitySrc" value="${tran.activityId}" readonly>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div id="nextContactTime" class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time" id="create-nextContactTime" value="${tran.nextContactTime}" readonly>
			</div>
		</div>
